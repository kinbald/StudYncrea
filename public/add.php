...
if ($_GET) {
    ...
    if ($type_post == 0 || $type_post == 1) {
        ...
        echo "<div class=\"row\">";
        $form->input('text', 'description', 'Description', true);
        echo "</div>";

        echo "<div class=\"row\">";
        $class = $Proms->all();
        $form->selectInput('class', 'Classe', $class, true);
        echo "</div>";

        echo "<div class=\"row\">";
        $chapter = $Chapters->getAll();
        $form->selectInput('chapter', 'Chapitre', $chapter, true);
        echo "</div>";

        echo "<div class=\"row\">";
        $subjects = $Subject->getAll();
        $form->selectInput('subject', 'Matière', $subjects, true);
        echo "</div>";

        echo "<div class=\"row\">";
        $teacher = $Users->getTeacher();
        $form->selectInput('teacher', 'Professeur', $teacher, true);
        echo "</div>";
