        ...
        <div class="col s12 m6 l6">
            <div class='card'>
                <div class="card-content">
                    <img class="circle" src="<?= $blog['url_avatar'] ?>" width="50" height="50">
                    ...
                    <?php
                        ...
                        if ($response_number['response_number'] > 1)
                        {
                            $text = " commentaires";
                        }
                        else
                    ...
                    <a class="right grey-text"
                       href="post.php?post=<?= $blog['id_post']; ?>"><?= $response_number['response_number'];
                            echo $text . "&emsp;"; ?><?= $Blog::display_date($blog['date_post']); ?></a>
                </div>
            </div>
        </div>
        <?php
